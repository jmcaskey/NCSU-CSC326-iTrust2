...
public enum TransactionType {
    ...
    /**
     * A Patient views their prescriptions
     */
    PRESCRIPTION_VIEW (900, "Patient views their prescriptions", true),
    /**
     * HCP creates a prescription for a patient
     */
    PRESCRIPTION_ADD (911, "HCP creates a prescription for a patient", false),
    /**
     * Admin adds an NDC Code to the system
     */
    NDC_ADD (921, "Admin adds an NDC code to the system", false),
    /**
     * Admin adds an IDC Code to the system
     */
    ICD_ADD (1022, "Admin adds an ICD code to the system", false),
    /**
     * Password is edited by a user
     */
    PASSWORD_UPDATE (1111, "User changes password", false)
    ;
