...
public class OfficeVisit extends DomainObject<OfficeVisit> {
    ...
    public OfficeVisit ( final OfficeVisitForm ovf ) throws ParseException, NumberFormatException {
        ...
        validateDiagnosisCode(ovf.getIcdCode());
        
    }

    /**
     * Validates a form to ensure that any diagnosis information is valid and can
     * be applied to this office visit.
     * @param ovf the form to validate
     */
    private void validateDiagnosisCode(String codeToCheck) {
    		if (codeToCheck == null || codeToCheck.equals("")) {
    			setIcdCode(null);
    			return; //There is no diagnosis associated with this office visit
    		}
    		
    		List<ICDCode> codesFromDB = ICDCode.getAll();
    		for 	(ICDCode code : codesFromDB) {
    			if (code.getCode().equals(codeToCheck)) {
    				setIcdCode(code);
    				return; //Found a valid code
    			}
    		}
    		
    		// The code provided is not associated with a code in the database
    ...
    /**
     * Gets the ICD-10 code for the diagnosis associated with this office visit
     * @return the ICD-10 code for this office visit
     */
    ...
    /**
     * Sets the ICD-10 code for the diagnosis associated with this office visit
     * @param icd the ICD-10 code to set
     */
    public void setIcdCode(ICDCode icd) {
    		this.icdCode = icd;
    }
    ...
    /**
     * The diagnosis associated with this office visit.
     */
    @OneToOne
