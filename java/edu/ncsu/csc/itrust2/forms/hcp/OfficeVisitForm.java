...
public class OfficeVisitForm implements Serializable {
    ...
    /**
     * The ICD-10 code describing the diagnostic associated with this office visit
     */
	...
	/**
	 * Returns the ICD-10 code corresponding to the diagnosis associated
	 * with this office visit
	 * @return the ICD-10 code if the diagnosis
	 */
	...
	/**
	 * Sets the ICD-10 code of the diagnosis associated with this office visit
	 * @param icdCode the ICD-10 code to set
	 */
