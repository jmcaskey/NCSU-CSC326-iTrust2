...
public class DocumentOfficeVisitStepDefs {
    ...
    public void documentedSuccessfully () {
        ...
        assertFalse( message.getText(), message.getText().contains( "Error" ) );
    ...
    public void notDocumented () {
        wait.until( ExpectedConditions.visibilityOfElementLocated( By.name( "errorMsg" ) ) );
        final WebElement message = driver.findElement( By.name( "errorMsg" ) );

        assertTrue( message.getText().contains( "Error" ) );
